...
//$subject = "Concretewind.com Contact Form Message";

$subject = "Request for a Tour";
...
<body class="page-tour">
    ...
    <div class="container">
       ...
       <!--  <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <p style="font-size: 14px;">Thanks for contacting me <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?>.<br />
