    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <span class="logoBranding"></span>
          <img class="carouselHeroImage img-responsive" src="assets/img/photos/home-hero.jpg" width="1024" height="262" alt="First slide" />

            <div class="carousel-caption">
            <div class="thumbnail">
              <div class="caption">
                <h3>Rooms</h3>
                <p>Starting at<span class="price">$575</span> a month</p>
