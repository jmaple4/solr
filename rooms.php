...
<head>
    ...
    <meta name="description" content="BEDS PER ROOM RENT PER BED Quad $575/mo. Triple $675/mo. Double $875/mo. Call 415.653.6070 for lease information." />
    <meta name="author" content="">
    <title>Room Types we offer</title>
...
<body class="page-rooms">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h1>We offer several types of rooms</h1>
            </div>
        </div>
        <!-- /row -->
        <div class="row">
